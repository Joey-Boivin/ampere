...
static void
_amp_wm_handle_backend_ready(struct amp_wm* wm, const struct amp_backend_event* event)
{
...
static void
_amp_wm_handle_key_pressed(struct amp_wm* wm, const struct amp_backend_event* event)
{
        /* TODO */
}

static void
_amp_wm_handle_window_create(struct amp_wm* wm, const struct amp_backend_event* event)
{
        /* TODO */
}

static void
_amp_wm_handle_window_removed(struct amp_wm* wm, const struct amp_backend_event* event)
{
        /* TODO */
}

static void
_amp_wm_handle_focus_in(struct amp_wm* wm, const struct amp_backend_event* event)
{
        /* TODO */
}
